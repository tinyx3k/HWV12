...
let buttons = [
{buttonId: `NYX WANGSAP☆`, buttonText: {displayText: hello}, type: 1},
]
let buttonMessage = {
...
let link = `https://youtube.com/c/HwModsWa857`
let buttons = [
{buttonId: `NYX WANGSAP☆`, buttonText: {displayText: bye}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let buttons = [
{buttonId: `NYX WANGSAP`, buttonText: {displayText: 'KASIAN'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `NYX WANGSAP`, buttonText: {displayText: 'SELAMAT'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
